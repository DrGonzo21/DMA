...
public class BorrowerEmploymentPage {
    ...
    public  BorrowerEmploymentPage() {
        ...
        @FindBy(xpath = "//input[@id='employername1']") private WebElement EmployerName;
        @FindBy(xpath = "//input[@id='position1']") private WebElement Position;
        @FindBy(xpath = "//input[@id='city']") private WebElement City;
        @FindBy(xpath = "//input[@id='state1']") private WebElement State; //Drop down
        @FindBy(xpath = "//input[@id='start_date1']") private WebElement StartDate;
        @FindBy(xpath = "//input[@id='end_date1']") private WebElement EndDate;
        @FindBy(xpath = "//button[@id='addemployer']") private WebElement AddAnotherEmployer;
        @FindBy(xpath = "//input[@id='employername2']") private WebElement EmployerName2;
        @FindBy(xpath = "//input[@id='position2']") private WebElement Position2;
        @FindBy(xpath = "//input[@id='city2']") private WebElement City2;
        @FindBy(xpath = "//input[@id='state2']") private WebElement State2;
        @FindBy(xpath = "//input[@id='start_date2']") private WebElement StartDate2;
        @FindBy(xpath = "//input[@id='end_date2']") private WebElement EndDate2;
        @FindBy(xpath = "//input[@id='grossmonthlyincome']") private WebElement GrossMonthlyIncome;
        @FindBy(xpath = "//input[@id='monthlyovertime']") private WebElement MonthlyOvertime;
        @FindBy(xpath = "//input[@id='monthlybonuses']") private WebElement MonthlyBonuses;
        @FindBy(xpath = "//input[@id='monthlycommission']") private WebElement MonthlyComissions;
        @FindBy(xpath = "//input[@id='monthlydividents']") private WebElement MonthlyDividents;
        @FindBy(xpath = "//select[@id='incomesource1']") private WebElement IncomeSource;
        @FindBy(xpath = "//select[@id='incomesource2']") private WebElement IncomeSource2;
        @FindBy(xpath = "//select[@id='incomesource3']") private WebElement IncomeSource3;
        @FindBy(xpath = "//input[@id='amount1']") private WebElement Amount;
        @FindBy(xpath = "//input[@id='amount2']") private WebElement Amount2;
        @FindBy(xpath = "//input[@id='amount3']") private WebElement Amount3;
    ...
    @Test
    public void borrowPageXtraEmployer(){
        getEmployerName().sendKeys(faker.name().firstName());
        getPosition().sendKeys(faker.job().position());
        getCity().sendKeys(faker.address().city());
        getState("AK").click();
